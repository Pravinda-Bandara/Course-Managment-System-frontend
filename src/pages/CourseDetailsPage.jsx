...
const CourseDetailsPage = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-6 text-white">Course Details</h1>
                    ...
                    <div className="space-y-6">
                        {isEditing ? (
                            ...
                            <>
                                ...
                                <p className="text-lg text-gray-700">
                                    <strong>Instructor Contact:</strong> {courseData.instructor_num}
                                </p>
                            </>
                        )}
                    </div>
                ...
                <div className="mt-8 flex flex-wrap items-center justify-between">
                    ...
                    {userInfo.role === 'admin' && (
                        <div className="flex space-x-4">
                            ...
                            >
                                <Edit className="mr-2" /> {isEditing ? 'Cancel Edit' : 'Edit Course'}
                            </button>
                            <button
